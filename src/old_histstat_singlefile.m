...
# 	z_mat = [0 0 0 0 1:column_to_save_length]';
	...
	ch_mat = [g(xz) g(xz0) g(xz1) g(xz2) g(xz3) g(xz4) g(xz5) g(xz6) g(xz7)];
	chfileheader = "z m0 m1 m2 m3 m4 m5 m6 m7";
	chfilename = strrep(resfilename, "ch.mat", "ch_moments.mat");
	save(chfilename, "chfileheader");
	save("-append", chfilename, "ch_mat");
